-- ═══ 0046 — مَن أنشأ المصروف + تعديل/حذف ذرّي (مشغّل في الإنتاج ✓)
-- المصدر (نسخة حرفية بلا تعديل إلا ما يوسم بـ ⚙️ إصلاح سلسلة): apps/pos/benamor-sales-system/supabase-pos-expenses-audit-list.sql
